...
(function () {
  ...
  var salesOrderChart = {
    ...
    chart: {
      ...
      dropShadow: {
        ...
        left: 0,
        blur: 6,
        color: MacaoAdminConfig.success,
        opacity: 0.3,
      },
    },
    stroke: {
    ...
    colors: [MacaoAdminConfig.success],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      points: [
        {
          ...
          marker: {
            size: 5,
            fillColor: MacaoAdminConfig.success,
            strokeWidth: 2,
            strokeColor: "#ffffff",
          },
        },
  ...
  var profitableCountryOptions = {
    ...
    colors: [MacaoAdminConfig.primary, MacaoAdminConfig.secondary, "#ffb829", MacaoAdminConfig.success, "#fc564a"],
    fill: {
      type: "gradient",
      opacity: 1,
      gradient: {
