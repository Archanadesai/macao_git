(function ($) {
  ...
  setTimeout(function () {
    $("#line-chart-sparkline").sparkline([5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20], {
      ...
      lineColor: MacaoAdminConfig.primary,
      fillColor: "rgba(225, 99, 73, 0.40)",
      highlightLineColor: MacaoAdminConfig.primary,
      highlightSpotColor: MacaoAdminConfig.primary,
      targetColor: MacaoAdminConfig.primary,
      performanceColor: MacaoAdminConfig.primary,
      boxFillColor: MacaoAdminConfig.primary,
      medianColor: MacaoAdminConfig.primary,
      minSpotColor: MacaoAdminConfig.primary,
    });
  });
  ...
  $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
    ...
    tooltipClassname: "chart-sparkline",
    chartRangeMax: "50",
    lineColor: MacaoAdminConfig.secondary,
    fillColor: "rgb(225 99 73 / 20%)",
    ...
    init: function () {
      setTimeout(function () {
        ...
        $("#bar-chart-sparkline").sparkline([5, 2, 2, 4, 9, 5, 7, 5, 2, 2, 6], {
          ...
          height: "100%",
          tooltipClassname: "chart-sparkline",
          barColor: MacaoAdminConfig.primary,
        }),
        $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
          type: "pie",
          width: "100%",
          height: "100%",
          sliceColors: ["#65c15c", "#ffb829", MacaoAdminConfig.secondary, MacaoAdminConfig.primary],
          tooltipClassname: "chart-sparkline",
        });
    },
  };
