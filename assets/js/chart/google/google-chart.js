  ...
  function drawBasic() {
    ...
    if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#ffb829", "#65c15c", "#a927f9", MacaoAdminConfig.secondary, MacaoAdminConfig.primary],
      };
    ...
    if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#ffb829", "#a927f9", "#65c15c", MacaoAdminConfig.secondary, MacaoAdminConfig.primary],
      };
        ...
        palette: [
          {
            ...
            dark: MacaoAdminConfig.secondary,
            light: "#047afb",
          },
        ],
      },
