  ...
  var barData = {
    ...
    datasets: [
      ...
      },
      {
        ...
        strokeColor: MacaoAdminConfig.secondary,
        highlightFill: "rgb(131,131,131,0.6)",
        highlightStroke: MacaoAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: MacaoAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    {
      value: 120,
      color: MacaoAdminConfig.secondary,
      highlight: MacaoAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
  ...
  var lineGraphData = {
    ...
    datasets: [
      ...
      },
      {
        ...
        strokeColor: MacaoAdminConfig.secondary,
        pointColor: MacaoAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: MacaoAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
