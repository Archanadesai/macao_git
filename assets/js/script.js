/*! -----------------------------------------------------------------------------------
    ...
    Template Name: Macao Admin
    Template URI: http://admin.pixelstrap.com/macao/template
...
(function ($) {
  ...
  $(".mode").on("click", function () {
    ...
    if (!bodyModeDark) {
      ...
      localStorage.setItem("mode-macao", "dark-only");
      $("body").addClass("dark-only");
      $("body").removeClass("light");
    }
    if (bodyModeDark) {
      $(".mode").removeClass("active");
      localStorage.setItem("mode-macao", "light");
      $("body").removeClass("dark-only");
      $("body").addClass("light");
    }
  });
  $("body").addClass(localStorage.getItem("mode-macao") ? localStorage.getItem("mode-macao") : "light");
  $(".mode").addClass(localStorage.getItem("mode-macao") === "dark-only" ? "active" : " ");
