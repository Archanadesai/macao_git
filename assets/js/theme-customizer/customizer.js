  ...
  $(document).ready(function () {
    ...
    switch (layout) {
      case "compact-sidebar": {
        ...
        $(this).addClass("active");
        localStorage.setItem("page-wrapper-macao", "compact-wrapper");
        break;
      }
      case "normal-sidebar": {
