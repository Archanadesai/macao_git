...
(function () {
  ...
  var optionslinechart2 = {
    ...
    colors: [MacaoAdminConfig.secondary],
    series: [
      {
        name: "series1",
        data: [70, 60, 82, 80, 60, 90, 70, 120, 50, 60, 0],
  ...
  var optionscolumnchart = {
    ...
    colors: [MacaoAdminConfig.secondary, "#65c15c", MacaoAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: MacaoAdminConfig.primary,
          label: {
            borderColor: MacaoAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: MacaoAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsuserchart = {
    ...
    colors: [MacaoAdminConfig.primary, MacaoAdminConfig.secondary, "#65c15c", "#544fff"],
    title: {
  ...
  var optionsCircle = {
    ...
    colors: [MacaoAdminConfig.secondary, MacaoAdminConfig.primary, "#65c15c"],
    responsive: [
      {
        breakpoint: 767,
        options: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [MacaoAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [MacaoAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [MacaoAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [MacaoAdminConfig.secondary],
      },
    },
    responsive: [
      {
